...
if __name__ == "__main__":
    ...
    input_csv = script_dir / "master-candidates.csv"
    output_csv = script_dir / "master-candidates-migrated.csv"
    ...
    print("\n" + "="*60)
    print("NEXT STEPS:")
    print("1. Review the migrated file: master-candidates-migrated.csv")
    print("2. If it looks good, replace the original:")
    print("   mv master-candidates-migrated.csv master-candidates.csv")
    print("="*60)
